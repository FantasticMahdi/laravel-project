                                                        ...
                                                        <form class="row" method="post"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <select name="province_id"
                                                                    ...
                                                                    @foreach ($provinces as $province)
                                                                        <option {{ $address->province_id == $province->id ? 'selected' : '' }} value="{{ $province->id }}"
                                                            ...
                                                            <section class="col-12 mb-2">
                                                                <section class="form-check">
                                                                    <input {{ $address->recipient_first_name ? 'checked' : '' }} class="form-check-input"
                                                                           name="receiver"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                <label for="first_name" class="form-label mb-1">نام
                                                                    گیرنده</label>
                                                                <input value="{{ $address->recipient_first_name ?? $address->recipient_first_name  }}"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <input value="{{ $address->recipient_last_name ?? $address->recipient_last_name  }}"
