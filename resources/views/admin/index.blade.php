            ...
            <a href="#" class="text-decoration-none d-block mb-4">
                <section class="card bg-custom-yellow text-white">
                    ...
                    <section class="card-footer info-box-footer">
                        ...
                        به روزرسانی شده در :21:42 بعد از ظهر
                    </section>
                </section>
            </a>
        </section>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    <h5>users section</h5>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, autem?</p>
                </section>
                <section class="body-content">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus quae accusantium sit
                        tenetur. Consequuntur sed doloribus iste quos eius dicta velit porro itaque, odio
                        possimus eos recusandae temporibus mollitia impedit.
                    </p>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ducimus quae accusantium sit
                        tenetur. Consequuntur sed doloribus iste quos eius dicta velit porro itaque, odio
                        possimus eos recusandae temporibus mollitia impedit.
