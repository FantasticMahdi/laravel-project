        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 pb-2">
                    <a href="{{ route('admin.market.discount.amazingSale.create') }}" class="btn btn-info btn-sm">ایجاد فروش شگفت انگیز جدید</a>
...
<a href="{{--  {{ route('admin.market.discount.show') }}  --}}" class="btn btn-info btn-sm"><i
