...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-14 active" aria-current="page"> ویرایش فروش ویژه</li>
        </ol>
    </nav>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="product_id" id="">
                                        ...
                                        @foreach($amazingSale->product->all() as $product)
