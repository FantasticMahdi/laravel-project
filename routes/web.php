...
Route::namespace('Auth')->group(function () {
    ...
    Route::middleware('throttle:customer-login-resend-otp-limiter')->get('login-resend-otp/{token}', [LoginRegisterController::class, 'LoginResendOtp'])->name('auth.customer.login-login-resend-otp');
